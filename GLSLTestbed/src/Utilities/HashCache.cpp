...
uint32_t HashCache::pk_MATRIX_OBJECT_TO_WORLD;
uint32_t HashCache::pk_MATRIX_WORLD_TO_OBJECT;
...
void HashCache::Intitialize()
{
    ...
    pk_MATRIX_OBJECT_TO_WORLD = StringHashID::StringToID("pk_MATRIX_OBJECT_TO_WORLD");
    pk_MATRIX_WORLD_TO_OBJECT = StringHashID::StringToID("pk_MATRIX_WORLD_TO_OBJECT");
