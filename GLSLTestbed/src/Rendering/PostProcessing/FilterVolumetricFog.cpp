...
namespace PK::Rendering::PostProcessing
{
    ...
    static const uint3 VolumeResolution = { 160u, 90u, 192u };
    ...
    FilterVolumetricFog::FilterVolumetricFog(AssetDatabase* assetDatabase) : FilterBase(assetDatabase->Find<Shader>("SH_VS_VolumeFogComposite"))
    {
        ...
        m_volumeInject = CreateRef<RenderTexture>(descriptor);
        ...
        auto bufferInject = m_volumeInject->GetColorBufferPtr(0);
        ...
        m_volumeResources->SetFloat(StringHashID::StringToID("pk_Volume_HeightFogExponent"), 4.0f);
        m_volumeResources->SetFloat(StringHashID::StringToID("pk_Volume_HeightFogOffset"), -1.0f);
        m_volumeResources->SetFloat(StringHashID::StringToID("pk_Volume_HeightFogAmount"), 0.01f);
        ...
        m_volumeResources->SetFloat(StringHashID::StringToID("pk_Volume_NoiseFogAmount"), 1.0f);
        ...
        m_properties.SetTexture(StringHashID::StringToID("pk_Volume_InjectRead"), bufferInject->GetGraphicsID());
